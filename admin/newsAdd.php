        ...
        <section>
            <div class="wrapper-full">
                <div class="column-holder">
                    ...
                    <form id="newsAddForm" class="column-xlarge-9 margintop-3 margintop-xlarge-0 editWrap">
                        ...
                        <div class="column-holder">
                            ...
                            <div class="column-small-12  marginbottom-3">
                                <textarea name="summary" id="summary" cols="30" rows="6" placeholder="Resumo"></textarea>
                            </div>
                            <div class="column-small-12  marginbottom-3">
                                <textarea name="matter" id="matter" cols="30" rows="10" placeholder="Matéria"></textarea>
                            </div>   
                        </div>
                        <div class="column-holder">
        ...
        $(document).ready(function(){
            $("#newsAddForm").on("submit", function(e){
                ...
                $.ajax({
                    type:"post",
                    dataType:"json",
                    url: "controller/AddNewsController.php",
                    data: data,
